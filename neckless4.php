			...
			<div class="row s_product_inner">
				<div class="col-lg-6">
					<div class="owl-carousel owl-theme s_Product_carousel">
						<div class="single-prd-item">
							<img class="img-fluid" src="img/neckless4.jpg" alt="">
						</div>
						<!-- <div class="single-prd-item">
				...
				<div class="col-lg-5 offset-lg-1">
					<div class="s_product_text">
						...
						<p>Handcrafted gold necklace with intricate details Gold Coin Necklace, Indian ... Luxurious Handcrafted Fine Gold Jewellery Designed For Life Beyond The Locker.</p>
