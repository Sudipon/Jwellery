          ...
          <section class="lattest-product-area pb-40 category-list">
            <div class="row">
              <div class="col-md-6 col-lg-4">
                <div class="card text-center card-product">
                  <div class="card-product__img">
                    <img class="card-img" src="img/pendant1.jpg" alt="" style="width: 250px;height: 180px;">
                  ...
                  <div class="card-body">
                    <p>Imported</p>
                    <h4 class="card-product__title"><a href="pendant1.php">Black onyx Clover design Pendant</a></h4>
              ...
              <div class="col-md-6 col-lg-4">
                <div class="card text-center card-product">
                  <div class="card-product__img">
                    <img class="card-img" src="img/pendant2.jpg" alt="" style="width: 250px;height: 180px;">
                    <ul class="card-product__imgOverlay">
                      <li><button><i class="ti-search"></i></button></li>
                      <li><button><i class="ti-shopping-cart"></i></button></li>
                      <li><button><i class="ti-heart"></i></button></li>
                  ...
                  <div class="card-body">
                    <p>Beauty</p>
                    <h4 class="card-product__title"><a href="pendant2.php">Net Design pendant</a></h4>
              ...
              <div class="col-md-6 col-lg-4">
                <div class="card text-center card-product">
                  <div class="card-product__img">
                    <img class="card-img" src="img/pendant3.jpg" alt="" style="width: 250px;height: 180px;">
                    <ul class="card-product__imgOverlay">
                      <li><button><i class="ti-search"></i></button></li>
                      <li><button><i class="ti-shopping-cart"></i></button></li>
                      <li><button><i class="ti-heart"></i></button></li>
                  ...
                  <div class="card-body">
                    <p>Decor</p>
                    <h4 class="card-product__title"><a href="pendant3.php">Ladies S design Diamond pendant</a></h4>
              ...
              <div class="col-md-6 col-lg-4">
                <div class="card text-center card-product">
                  <div class="card-product__img">
                    <img class="card-img" src="img/pendant4.jpg" alt="" style="width: 250px;height: 180px;">
                    <ul class="card-product__imgOverlay">
                      <li><button><i class="ti-search"></i></button></li>
                      <li><button><i class="ti-shopping-cart"></i></button></li>
                      <li><button><i class="ti-heart"></i></button></li>
                  ...
                  <div class="card-body">
                    <p>Beauty</p>
                    <h4 class="card-product__title"><a href="pendant4.php">Lovely crystal Pendant</a></h4>
              ...
              <div class="col-md-6 col-lg-4">
                <div class="card text-center card-product">
                  <div class="card-product__img">
                    <img class="card-img" src="img/pendant5.jpg" alt="" style="width: 250px;height: 180px;">
                    <ul class="card-product__imgOverlay">
                      <li><button><i class="ti-search"></i></button></li>
                      <li><button><i class="ti-shopping-cart"></i></button></li>
                      <li><button><i class="ti-heart"></i></button></li>
                  ...
                  <div class="card-body">
                    <p>Accessories</p>
                    <h4 class="card-product__title"><a href="pendant5.php">Pendant shitri</a></h4>
              ...
              <div class="col-md-6 col-lg-4">
                <div class="card text-center card-product">
                  <div class="card-product__img">
                    <img class="card-img" src="img/pendant6.jpg" alt="" style="width: 250px;height: 180px;">
                    <ul class="card-product__imgOverlay">
                      <li><button><i class="ti-search"></i></button></li>
                      <li><button><i class="ti-shopping-cart"></i></button></li>
                      <li><button><i class="ti-heart"></i></button></li>
                  ...
                  <div class="card-body">
                    <p>export</p>
                    <h4 class="card-product__title"><a href="pendant6.php">Love wine women pendant</a></h4>
