			...
			<div class="row s_product_inner">
				<div class="col-lg-6">
					<div class="owl-carousel owl-theme s_Product_carousel">
						<div class="single-prd-item">
							<img class="img-fluid" src="img/pendant1.jpg" alt="">
						</div>
						<!-- <div class="single-prd-item">
				...
				<div class="col-lg-5 offset-lg-1">
					<div class="s_product_text">
						<h3>Black onyx Clover design Pendant</h3>
						<h2>Rs.15000.00</h2>
						<ul class="list">
							<li><a class="active" href="#"><span>Category</span> : Household</a></li>
							<li><a href="#"><span>Availibility</span> : In Stock</a></li>
						</ul>
						<p>Genuine Black Onyx Clover Design Pendant Necklace 14Kt Yellow Gold Rose Gold Silver. This is a beautiful clover pendant design. The pendant size is 15mm (0.590 inches) x 15mm (0.590 inches) and gemstone size is 3mm. The pendant comes an 18 inch chain and comes in a jewelry box.</p>
