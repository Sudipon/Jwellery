			...
			<div class="row s_product_inner">
				<div class="col-lg-6">
					<div class="owl-carousel owl-theme s_Product_carousel">
						<div class="single-prd-item">
							<img class="img-fluid" src="img/pendant6.jpg" alt="">
						</div>
						<!-- <div class="single-prd-item">
				...
				<div class="col-lg-5 offset-lg-1">
					<div class="s_product_text">
						<h3>Love wine women pendant</h3>
						<h2>Rs.25000.00</h2>
						<ul class="list">
							<li><a class="active" href="#"><span>Category</span> : Household</a></li>
							<li><a href="#"><span>Availibility</span> : In Stock</a></li>
						</ul>
						<p>SKQIR Stainless Steel Love Wine Cheers Hollow Heart Pendant Necklace Women's Girl's 18'' Jewelry. Roll over image to zoom in. SKQIR. Wine Glass Bottle Pendant Necklace for women Girls,Stainless Steel Love Wine ... </p>
