			...
			<div class="row s_product_inner">
				<div class="col-lg-6">
					<div class="owl-carousel owl-theme s_Product_carousel">
						<div class="single-prd-item">
							<img class="img-fluid" src="img/ring4.jpg" alt="">
						</div>
						<!-- <div class="single-prd-item">
				...
				<div class="col-lg-5 offset-lg-1">
					<div class="s_product_text">
						<h3>Platinum Gold bands</h3>
						<h2>Rs.16000.00</h2>
						<ul class="list">
							<li><a class="active" href="#"><span>Category</span> : Household</a></li>
							<li><a href="#"><span>Availibility</span> : In Stock</a></li>
						</ul>
						<p>Platinum rings are symbolic of love. Just like true love, platinum is pure, rare & eternal. Platinum is a very rare metal, almost 30 times rarer than gold and it is much stronger than gold, which makes platinum love bands & rings extremely strong & ideal for daily use.</p>
