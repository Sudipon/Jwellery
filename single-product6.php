			...
			<div class="row s_product_inner">
				<div class="col-lg-6">
					<div class="owl-carousel owl-theme s_Product_carousel">
						<div class="single-prd-item">
							<img class="img-fluid" src="img/product/product6.jpg" alt="">
						</div>
						<!-- <div class="single-prd-item">
				...
				<div class="col-lg-5 offset-lg-1">
					<div class="s_product_text">
						...
						<p>An important emerging sector of Indian economy, gem and jewelry is a leading foreign exchange earner for the country. ... The two major segments of the gem and jewelry industry in India are gold jewelery and diamonds.</p>
