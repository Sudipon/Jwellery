			...
			<div class="row s_product_inner">
				<div class="col-lg-6">
					<div class="owl-carousel owl-theme s_Product_carousel">
						<div class="single-prd-item">
							<img class="img-fluid" src="img/payel6.jpg" alt="">
						</div>
						<!-- <div class="single-prd-item">
				...
				<div class="col-lg-5 offset-lg-1">
					<div class="s_product_text">
						<h3>Indian silver Anklets</h3>
						<h2>Rs.2500.00</h2>
						<ul class="list">
							<li><a class="active" href="#"><span>Category</span> : Household</a></li>
							<li><a href="#"><span>Availibility</span> : In Stock</a></li>
						</ul>
						<p>Product Details We are engaged in providing superior quality Traditional Indian Silver Anklet to our most reliable clients. Stylish look and exclusive shape of our silver anklet sets it apart from the ordinary anklets available in the market. We provide anklet in different sizes as per the requirements of the clients.</p>
