			...
			<div class="row s_product_inner">
				<div class="col-lg-6">
					<div class="owl-carousel owl-theme s_Product_carousel">
						<div class="single-prd-item">
							<img class="img-fluid" src="img/ring6.jpg" alt="">
						</div>
						<!-- <div class="single-prd-item">
				...
				<div class="col-lg-5 offset-lg-1">
					<div class="s_product_text">
						...
						<p>Silver Rings - Buy Silver Rings online for men & women from top brands. Get Silver Rings in various sizes, platings & more types for different occasions at ... Oxidised jewellery is an option which brings out the design details as well as contrast.</p>
