			...
			<div class="row s_product_inner">
				...
				<div class="col-lg-5 offset-lg-1">
					<div class="s_product_text">
						<h3>Tamilnadu Jewellery</h3>
						<h2>Rs.10000.00</h2>
						<ul class="list">
							<li><a class="active" href="#"><span>Category</span> : Household</a></li>
							<li><a href="#"><span>Availibility</span> : In Stock</a></li>
						</ul>
						<p>The Tamil Bride regards auspicious rituals and customs with great reverance, and heads into her Kalayanam with a sense of eloquence. The jewellery she wears is as spiritually significant as the customs of every ceremony.</p>
