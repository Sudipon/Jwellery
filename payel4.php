			...
			<div class="row s_product_inner">
				<div class="col-lg-6">
					<div class="owl-carousel owl-theme s_Product_carousel">
						<div class="single-prd-item">
							<img class="img-fluid" src="img/payel4.jpg" alt="">
						</div>
						<!-- <div class="single-prd-item">
				...
				<div class="col-lg-5 offset-lg-1">
					<div class="s_product_text">
						...
						<p>Company Details Our wide range of products includes Silver Key Chain, Women's Anklet, Silver Pendant, Silver Bracelet and many more in the list. All our products are based on traditional and modern design which adds a graceful look to our products range.</p>
