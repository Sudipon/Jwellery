          ...
          <section class="lattest-product-area pb-40 category-list">
            <div class="row">
              <div class="col-md-6 col-lg-4">
                <div class="card text-center card-product">
                  <div class="card-product__img">
                    <img class="card-img" src="img/bangles1.jpg" alt="" style="width: 250px;height: 180px;">
                  ...
                  <div class="card-body">
                    <p>Imported</p>
                    <h4 class="card-product__title"><a href="bangles1.php">Big Broad gold bangles</a></h4>
              ...
              <div class="col-md-6 col-lg-4">
                <div class="card text-center card-product">
                  <div class="card-product__img">
                    <img class="card-img" src="img/bangles2.jpg" alt="" style="width: 250px;height: 180px;">
                    <ul class="card-product__imgOverlay">
                      <li><button><i class="ti-search"></i></button></li>
                      <li><button><i class="ti-shopping-cart"></i></button></li>
                      <li><button><i class="ti-heart"></i></button></li>
                  ...
                  <div class="card-body">
                    <p>Beauty</p>
                    <h4 class="card-product__title"><a href="bangles2.php">Chura Rajasthani wedding bangles</a></h4>
              ...
              <div class="col-md-6 col-lg-4">
                <div class="card text-center card-product">
                  <div class="card-product__img">
                    <img class="card-img" src="img/bangles3.jpg" alt="" style="width: 250px;height: 180px;">
                    <ul class="card-product__imgOverlay">
                      <li><button><i class="ti-search"></i></button></li>
                      <li><button><i class="ti-shopping-cart"></i></button></li>
                      <li><button><i class="ti-heart"></i></button></li>
                  ...
                  <div class="card-body">
                    <p>Decor</p>
                    <h4 class="card-product__title"><a href="bangles3.php">Adjustable screw bangles</a></h4>
              ...
              <div class="col-md-6 col-lg-4">
                <div class="card text-center card-product">
                  <div class="card-product__img">
                    <img class="card-img" src="img/bangles4.jpg" alt="" style="width: 250px;height: 180px;">
                    <ul class="card-product__imgOverlay">
                      <li><button><i class="ti-search"></i></button></li>
                      <li><button><i class="ti-shopping-cart"></i></button></li>
                      <li><button><i class="ti-heart"></i></button></li>
                  ...
                  <div class="card-body">
                    <p>Beauty</p>
                    <h4 class="card-product__title"><a href="bangles4.php">Silver Plated Oxidised bangles</a></h4>
              ...
              <div class="col-md-6 col-lg-4">
                <div class="card text-center card-product">
                  <div class="card-product__img">
                    <img class="card-img" src="img/bangles5.jpg" alt="" style="width: 250px;height: 180px;">
                    <ul class="card-product__imgOverlay">
                      <li><button><i class="ti-search"></i></button></li>
                      <li><button><i class="ti-shopping-cart"></i></button></li>
                      <li><button><i class="ti-heart"></i></button></li>
                  ...
                  <div class="card-body">
                    <p>Accessories</p>
                    <h4 class="card-product__title"><a href="bangles5.php">Designer bangles</a></h4>
              ...
              <div class="col-md-6 col-lg-4">
                <div class="card text-center card-product">
                  <div class="card-product__img">
                    <img class="card-img" src="img/bangles6.jpg" alt="" style="width: 250px;height: 180px;">
                    <ul class="card-product__imgOverlay">
                      <li><button><i class="ti-search"></i></button></li>
                      <li><button><i class="ti-shopping-cart"></i></button></li>
                      <li><button><i class="ti-heart"></i></button></li>
                  ...
                  <div class="card-body">
                    <p>export</p>
                    <h4 class="card-product__title"><a href="bangles6.php">Alloy style bangles </a></h4>
