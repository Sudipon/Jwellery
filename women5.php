			...
			<div class="row s_product_inner">
				<div class="col-lg-6">
					<div class="owl-carousel owl-theme s_Product_carousel">
						<div class="single-prd-item">
							<img class="img-fluid" src="img/women5.jpg" alt="">
						</div>
						<!-- <div class="single-prd-item">
				...
				<div class="col-lg-5 offset-lg-1">
					<div class="s_product_text">
						<h3>Adjustable Free size gold Chain Bracelet ring</h3>
						<h2>Rs.17000.00</h2>
						<ul class="list">
							<li><a class="active" href="#"><span>Category</span> : Household</a></li>
							<li><a href="#"><span>Availibility</span> : In Stock</a></li>
						</ul>
						<p>Buy Amaal Fashion Jewellery Adjustable Freesize Gold Chain Bracelet Rings for Girls ... No Minimum order value for first order in this category Details ... Pearl Bracelet Ring for girlfriend ring for girls fancy love rings best option in ... jewellery for women wedding gifts party wear rings silver rings in crystal ... Cute and stylish.
					...
					<div class="row">
						...
						<div class="col-lg-6">
							<div class="review_box">
								...
								<p>Outstanding</p>
                <form action="review.php" class="form-contact form-review mt-3" method="POST">
                  <div class="form-group">
