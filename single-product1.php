			...
			<div class="row s_product_inner">
				...
				<div class="col-lg-5 offset-lg-1">
					<div class="s_product_text">
						<h3>Sawansukha Jewellery</h3>
						<h2>Rs.15000.00</h2>
						<ul class="list">
							<li><a class="active" href="#"><span>Category</span> : Household</a></li>
							<li><a href="#"><span>Availibility</span> : In Stock</a></li>
						</ul>
						<p>Witness Magnificence with the Best Jewellery Shop in Kolkata S awansukha's have been traditional diamond Merchants for 250+ years. In Kolkata the first seeds of business were sown by Mr. Rupchand Sawansukha in the early 1970, when the fledgling trade in wholesale diamonds was started from Lal-kothi in Burrabazar.</p>
