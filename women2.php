			...
			<div class="row s_product_inner">
				<div class="col-lg-6">
					<div class="owl-carousel owl-theme s_Product_carousel">
						<div class="single-prd-item">
							<img class="img-fluid" src="img/women2.jpg" alt="">
						</div>
						<!-- <div class="single-prd-item">
				...
				<div class="col-lg-5 offset-lg-1">
					<div class="s_product_text">
						<h3>Gold Platted Bangles</h3>
						<h2>Rs.15300.00</h2>
						<ul class="list">
							<li><a class="active" href="#"><span>Category</span> : Household</a></li>
							<li><a href="#"><span>Availibility</span> : In Stock</a></li>
						</ul>
						<p>24ct 1 gram gold forming african fancy kada. the base material is copper and the gold is deposited on it through various processes. We have a wide range of designs in bangles, necklaces and other related jewellery. we are providing best quality and services to our customer.
						</p>
