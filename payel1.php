			...
			<div class="row s_product_inner">
				<div class="col-lg-6">
					<div class="owl-carousel owl-theme s_Product_carousel">
						<div class="single-prd-item">
							<img class="img-fluid" src="img/payel1.jpg" alt="">
						</div>
						<!-- <div class="single-prd-item">
				...
				<div class="col-lg-5 offset-lg-1">
					<div class="s_product_text">
						<h3>Silver Tone indian Traditional Chain</h3>
						<h2>Rs.1500.00</h2>
						<ul class="list">
							<li><a class="active" href="#"><span>Category</span> : Household</a></li>
							<li><a href="#"><span>Availibility</span> : In Stock</a></li>
						</ul>
						<p>Peegli Indian Foot Chain Silver Tone Anklet Traditional Women's Ethnic Ankle Bracelet. ... ✦ It is fashion silvertone anklets with bells. It is decorated with multicolor CZ stone. Easy to wear, light in weight & gives you a rich look.</p>
