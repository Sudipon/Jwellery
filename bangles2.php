			...
			<div class="row s_product_inner">
				<div class="col-lg-6">
					<div class="owl-carousel owl-theme s_Product_carousel">
						<div class="single-prd-item">
							<img class="img-fluid" src="img/bangles2.jpg" alt="">
						</div>
						<!-- <div class="single-prd-item">
				...
				<div class="col-lg-5 offset-lg-1">
					<div class="s_product_text">
						<h3>Chura Rajasthani wedding bangles</h3>
						<h2>Rs.1530.00</h2>
						<ul class="list">
							<li><a class="active" href="#"><span>Category</span> : Household</a></li>
							<li><a href="#"><span>Availibility</span> : In Stock</a></li>
						</ul>
						<p>A Choora is a set of bangles that are usually red and white, sometimes the red bangles are replaced with another color, but they are usually only two colors. Traditionally made of ivory, with inlay work, though now made with plastic they are worn by a bride on her wedding day.</p>
