			...
			<div class="row s_product_inner">
				...
				<div class="col-lg-5 offset-lg-1">
					<div class="s_product_text">
						<h3>Gold Rope Chain</h3>
						<h2>Rs.1700.00</h2>
						<ul class="list">
							<li><a class="active" href="#"><span>Category</span> : Household</a></li>
							<li><a href="#"><span>Availibility</span> : In Stock</a></li>
						</ul>
						<p>Select your favorite Rope Chain from our latest Gold Chain Designs at the affordable price in Kalyan Jewellers. We provide wide range variety designs in Gold</p>
