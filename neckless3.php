			...
			<div class="row s_product_inner">
				<div class="col-lg-6">
					<div class="owl-carousel owl-theme s_Product_carousel">
						<div class="single-prd-item">
							<img class="img-fluid" src="img/neckless3.jpg" alt="">
						</div>
						<!-- <div class="single-prd-item">
				...
				<div class="col-lg-5 offset-lg-1">
					<div class="s_product_text">
						<h3>Neck design Necklacee</h3>
						<h2>Rs.13000.00</h2>
						<ul class="list">
							<li><a class="active" href="#"><span>Category</span> : Household</a></li>
							<li><a href="#"><span>Availibility</span> : In Stock</a></li>
						</ul>
						<p>Jewellery Neck Set. Manufacturer of a wide range of products which include Jewellery Neck Set such as Color Stone Jewellery Set, Silver Neck Chain Set, Imitation Gold Jewelry Set, Gold Necklace Set, Imitation Diamond Necklace Set, Simple Design Gold Necklace Set and many more items.</p>
