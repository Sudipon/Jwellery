			...
			<div class="row s_product_inner">
				...
				<div class="col-lg-5 offset-lg-1">
					<div class="s_product_text">
						<h3>Hall Mark Jewellery</h3>
						<h2>Rs.13000.00</h2>
						<ul class="list">
							<li><a class="active" href="#"><span>Category</span> : Household</a></li>
							<li><a href="#"><span>Availibility</span> : In Stock</a></li>
						</ul>
						<p>The BIS hallmark is a hallmarking system for gold as well as silver jewellery sold in India certifying the purity of the metal. It certifies that the piece of jewellery conforms to a set of standards laid by the Bureau of Indian Standards, the national standards organization of India.</p>
