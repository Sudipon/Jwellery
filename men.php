          ...
          <section class="lattest-product-area pb-40 category-list">
            <div class="row">
              <div class="col-md-6 col-lg-4">
                <div class="card text-center card-product">
                  <div class="card-product__img">
                    <img class="card-img" src="img/category1.jpg" alt="" style="width: 250px;height: 180px;">
                  ...
                  <div class="card-body">
                    <p>Imported</p>
                    <h4 class="card-product__title"><a href="men1.php">Gold Bangles</a></h4>
              ...
              <div class="col-md-6 col-lg-4">
                <div class="card text-center card-product">
                  <div class="card-product__img">
                    <img class="card-img" src="img/category2.jpg" alt="" style="width: 250px;height: 180px;">
                    <ul class="card-product__imgOverlay">
                      <li><button><i class="ti-search"></i></button></li>
                      <li><button><i class="ti-shopping-cart"></i></button></li>
                      <li><button><i class="ti-heart"></i></button></li>
                  ...
                  <div class="card-body">
                    <p>Beauty</p>
                    <h4 class="card-product__title"><a href="men2.php">Lotus Chain</a></h4>
              ...
              <div class="col-md-6 col-lg-4">
                <div class="card text-center card-product">
                  <div class="card-product__img">
                    <img class="card-img" src="img/category3.jpg" alt="" style="width: 250px;height: 180px;">
                    <ul class="card-product__imgOverlay">
                      <li><button><i class="ti-search"></i></button></li>
                      <li><button><i class="ti-shopping-cart"></i></button></li>
                      <li><button><i class="ti-heart"></i></button></li>
                  ...
                  <div class="card-body">
                    <p>Decor</p>
                    <h4 class="card-product__title"><a href="men3.php">TrustyLan Chain</a></h4>
                    <p class="card-product__price">Rs.1300.00</p>
                  </div>
                </div>
              </div>
              <div class="col-md-6 col-lg-4">
                <div class="card text-center card-product">
                  <div class="card-product__img">
                    <img class="card-img" src="img/category4.jpg" alt="" style="width: 250px;height: 180px;">
                    <ul class="card-product__imgOverlay">
                      <li><button><i class="ti-search"></i></button></li>
                      <li><button><i class="ti-shopping-cart"></i></button></li>
                      <li><button><i class="ti-heart"></i></button></li>
                  ...
                  <div class="card-body">
                    <p>Beauty</p>
                    <h4 class="card-product__title"><a href="men4.php">Sunbera Gold Rings</a></h4>
              ...
              <div class="col-md-6 col-lg-4">
                <div class="card text-center card-product">
                  <div class="card-product__img">
                    <img class="card-img" src="img/category5.jpg" alt="" style="width: 250px;height: 180px;">
                    <ul class="card-product__imgOverlay">
                      <li><button><i class="ti-search"></i></button></li>
                      <li><button><i class="ti-shopping-cart"></i></button></li>
                      <li><button><i class="ti-heart"></i></button></li>
                  ...
                  <div class="card-body">
                    <p>Accessories</p>
                    <h4 class="card-product__title"><a href="men5.php">Gold Rope Chain</a></h4>
