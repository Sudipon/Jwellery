			...
			<div class="row s_product_inner">
				<div class="col-lg-6">
					<div class="owl-carousel owl-theme s_Product_carousel">
						<div class="single-prd-item">
							<img class="img-fluid" src="img/neckless1.jpg" alt="">
						</div>
						<!-- <div class="single-prd-item">
				...
				<div class="col-lg-5 offset-lg-1">
					<div class="s_product_text">
						<h3>Multi Color haram neckless</h3>
						<h2>Rs.15000.00</h2>
						<ul class="list">
							<li><a class="active" href="#"><span>Category</span> : Household</a></li>
							<li><a href="#"><span>Availibility</span> : In Stock</a></li>
						</ul>
						<p>Lepakshi Handicrafts Emporium - offering Multicolor Cizeal Stones Long Haram in Kolkata, West Bengal. Read about company and get contact details and address. | ID: 19134055048. ... Golden American Diamond Long Necklace Haram Set.</p>
