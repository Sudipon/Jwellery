			...
			<div class="row s_product_inner">
				<div class="col-lg-6">
					<div class="owl-carousel owl-theme s_Product_carousel">
						<div class="single-prd-item">
							<img class="img-fluid" src="img/ring5.jpg" alt="">
						</div>
						<!-- <div class="single-prd-item">
				...
				<div class="col-lg-5 offset-lg-1">
					<div class="s_product_text">
						<h3>Precious rings</h3>
						<h2>Rs.17000.00</h2>
						<ul class="list">
							<li><a class="active" href="#"><span>Category</span> : Household</a></li>
							<li><a href="#"><span>Availibility</span> : In Stock</a></li>
						</ul>
						<p>Red Gemstone Rings, Green Gemstone Rings, Blue Gemstone Rings and Yellow Gemstone Rings are most common types of rings. Ruby, one of the most precious gemstone, is a symbol of Love, Passion and Care. Ruby is often known as Lucky Gemstone.</p>
