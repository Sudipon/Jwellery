			...
			<div class="row s_product_inner">
				<div class="col-lg-6">
					<div class="owl-carousel owl-theme s_Product_carousel">
						<div class="single-prd-item">
							<img class="img-fluid" src="img/women6.jpg" alt="">
						</div>
						<!-- <div class="single-prd-item">
				...
				<div class="col-lg-5 offset-lg-1">
					<div class="s_product_text">
						...
						<p>An earring is a piece of jewelry attached to the ear via a piercing in the earlobe or another ... Howard Carter writes in his description of Tutankhamun's tomb that the Pharaoh's earlobes were perforated
