			...
			<div class="row s_product_inner">
				<div class="col-lg-6">
					<div class="owl-carousel owl-theme s_Product_carousel">
						<div class="single-prd-item">
							<img class="img-fluid" src="img/pendant3.jpg" alt="">
						</div>
						<!-- <div class="single-prd-item">
				...
				<div class="col-lg-5 offset-lg-1">
					<div class="s_product_text">
						<h3>Ladies S design Diamond pendant</h3>
						<h2>Rs.13000.00</h2>
						<ul class="list">
							<li><a class="active" href="#"><span>Category</span> : Household</a></li>
							<li><a href="#"><span>Availibility</span> : In Stock</a></li>
						</ul>
						<p>Rikhava Diamonds - offering Rose Gold Women''s Diamond Pendant Set With Chain & Ring at Rs 96742/set in Mumbai, ... Get best price and read about company and get contact details and address</p>
