			...
			<div class="row s_product_inner">
				<div class="col-lg-6">
					<div class="owl-carousel owl-theme s_Product_carousel">
						<div class="single-prd-item">
							<img class="img-fluid" src="img/pendant4.jpg" alt="">
						</div>
						<!-- <div class="single-prd-item">
				...
				<div class="col-lg-5 offset-lg-1">
					<div class="s_product_text">
						<h3>Lovely crystal Pendant</h3>
						<h2>Rs.16000.00</h2>
						<ul class="list">
							<li><a class="active" href="#"><span>Category</span> : Household</a></li>
							<li><a href="#"><span>Availibility</span> : In Stock</a></li>
						</ul>
						<p>Swarovski Symbolic Charm Necklace, Light multi-colored, Rhodium plated. ... Swarovski Symbolic Necklace, White, Rose-gold tone plated. ... A sparkling selection of exquisitely crafted crystal necklaces including chokers, collar necklaces and more in a variety of plating tones.</p>
