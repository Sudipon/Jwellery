			...
			<div class="row s_product_inner">
				<div class="col-lg-6">
					<div class="owl-carousel owl-theme s_Product_carousel">
						<div class="single-prd-item">
							<img class="img-fluid" src="img/bangles3.jpg" alt="">
						</div>
						<!-- <div class="single-prd-item">
				...
				<div class="col-lg-5 offset-lg-1">
					<div class="s_product_text">
						<h3>Adjustable screw bangles</h3>
						<h2>Rs.1300.00</h2>
						<ul class="list">
							<li><a class="active" href="#"><span>Category</span> : Household</a></li>
							<li><a href="#"><span>Availibility</span> : In Stock</a></li>
						</ul>
						<p>22k Gold Plated Adjustable CNC Drawstring Bracelet for Women and Girls ... 22k Gold Plated with Rhodium Details Facet Cut CNC Bangles for Women ... Traditional Antique Kundan Curvy Screw Foldable Kada Bracelets.</p>
