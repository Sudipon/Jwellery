			...
			<div class="row s_product_inner">
				...
				<div class="col-lg-5 offset-lg-1">
					<div class="s_product_text">
						<h3>Dhanteras Jewellery</h3>
						<h2>Rs.15000.00</h2>
						<ul class="list">
							<li><a class="active" href="#"><span>Category</span> : Household</a></li>
							<li><a href="#"><span>Availibility</span> : In Stock</a></li>
						</ul>
						<p>Jewellers see no sparkle in sales this Dhanteras
							NEW DELHI/MUMBAI: Gold and jewellery sales were muted so far on the occasion of Dhanteras as people preferred silver coins and utentils for token buying amid sluggish consumer spending and high rates of the precious metal, according to industry players.</p>
