			...
			<div class="row s_product_inner">
				<div class="col-lg-6">
					<div class="owl-carousel owl-theme s_Product_carousel">
						<div class="single-prd-item">
							<img class="img-fluid" src="img/ring3.jpg" alt="">
						</div>
						<!-- <div class="single-prd-item">
				...
				<div class="col-lg-5 offset-lg-1">
					<div class="s_product_text">
						...
						<p>Most men shop to one to three months before buying the engagement ring. ... Of the three rings that will be purchased, it is common to buy the engagement ring first, then the wedding bands. Most couples prefer wedding bands that match the metal of the engagement ring and complement it in both look and fit.</p>
