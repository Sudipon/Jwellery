			...
			<div class="row s_product_inner">
				<div class="col-lg-6">
					<div class="owl-carousel owl-theme s_Product_carousel">
						<div class="single-prd-item">
							<img class="img-fluid" src="img/neckless5.jpg" alt="">
						</div>
						<!-- <div class="single-prd-item">
				...
				<div class="col-lg-5 offset-lg-1">
					<div class="s_product_text">
						<h3>Stylish gold plated designers Necklace</h3>
						<h2>Rs.17000.00</h2>
						<ul class="list">
							<li><a class="active" href="#"><span>Category</span> : Household</a></li>
							<li><a href="#"><span>Availibility</span> : In Stock</a></li>
						</ul>
						<p>Shining Diva Fashion Latest Choker Design Traditional Necklace Set Gold ... 18k Gold Plated Wedding Party Wear Stylish Traditional Choker Necklace Jewellery Set for Women ... No Minimum order value for first order in this category Details.</p>
