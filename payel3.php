			...
			<div class="row s_product_inner">
				<div class="col-lg-6">
					<div class="owl-carousel owl-theme s_Product_carousel">
						<div class="single-prd-item">
							<img class="img-fluid" src="img/payel3.jpg" alt="">
						</div>
						<!-- <div class="single-prd-item">
				...
				<div class="col-lg-5 offset-lg-1">
					<div class="s_product_text">
						...
						<p>Anklets are a style statement. ... Our collection of silver anklets is designed keeping traditional styles and modern trends in mind. Our silver payal collection ranges from simple payals to unique pieces encrusted with precious stones, and more.</p>
