			...
			<div class="row s_product_inner">
				<div class="col-lg-6">
					<div class="owl-carousel owl-theme s_Product_carousel">
						<div class="single-prd-item">
							<img class="img-fluid" src="img/women3.jpg" alt="">
						</div>
						<!-- <div class="single-prd-item">
				...
				<div class="col-lg-5 offset-lg-1">
					<div class="s_product_text">
						<h3>Gold Heart Pendant</h3>
						<h2>Rs.13000.00</h2>
						<ul class="list">
							<li><a class="active" href="#"><span>Category</span> : Household</a></li>
							<li><a href="#"><span>Availibility</span> : In Stock</a></li>
						</ul>
						<p>Malabar Gold and Diamonds is literally winning hearts with its gorgeous and glamorous gold heart-shaped jewellery. The collection includes gold heart pendants, gold heart rings, gold heart earrings, and gold heart necklaces. The accessories are in the latest designs and the craftsmanship is to drool over.
						</p>
