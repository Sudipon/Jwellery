			...
			<div class="row s_product_inner">
				<div class="col-lg-6">
					<div class="owl-carousel owl-theme s_Product_carousel">
						<div class="single-prd-item">
							<img class="img-fluid" src="img/women4.jpg" alt="">
						</div>
						<!-- <div class="single-prd-item">
				...
				<div class="col-lg-5 offset-lg-1">
					<div class="s_product_text">
						<h3>Stylish crystal fancy party Wear Neckless</h3>
						<h2>Rs.16000.00</h2>
						<ul class="list">
							<li><a class="active" href="#"><span>Category</span> : Household</a></li>
							<li><a href="#"><span>Availibility</span> : In Stock</a></li>
						</ul>
						<p>Buy TJAS Stylish Crystal Fancy Party Wear Necklace Set with Earrings for Girls and Women from Pendants at Amazon.in. 30 days ... Latest Pendant - Fashion Jewelry presents these Stylish Pendant suitable for party wear.
						</p>
