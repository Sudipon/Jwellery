          ...
          <section class="lattest-product-area pb-40 category-list">
            <div class="row">
              <div class="col-md-6 col-lg-4">
                <div class="card text-center card-product">
                  <div class="card-product__img">
                    <img class="card-img" src="img/neckless1.jpg" alt="" style="width: 250px;height: 180px;">
                  ...
                  <div class="card-body">
                    <p>Imported</p>
                    <h4 class="card-product__title"><a href="neckless1.php">Multi Color haram neckless</a></h4>
              ...
              <div class="col-md-6 col-lg-4">
                <div class="card text-center card-product">
                  <div class="card-product__img">
                    <img class="card-img" src="img/neckless2.jpg" alt="" style="width: 250px;height: 180px;">
                    <ul class="card-product__imgOverlay">
                      <li><button><i class="ti-search"></i></button></li>
                      <li><button><i class="ti-shopping-cart"></i></button></li>
                      <li><button><i class="ti-heart"></i></button></li>
                  ...
                  <div class="card-body">
                    <p>Beauty</p>
                    <h4 class="card-product__title"><a href="neckless2.php">Gold designers Necklace</a></h4>
                    <p class="card-product__price">Rs.15300.00</p>
                  </div>
                </div>
              </div>
              <div class="col-md-6 col-lg-4">
                <div class="card text-center card-product">
                  <div class="card-product__img">
                    <img class="card-img" src="img/neckless3.jpg" alt="" style="width: 250px;height: 180px;">
                    <ul class="card-product__imgOverlay">
                      <li><button><i class="ti-search"></i></button></li>
                      <li><button><i class="ti-shopping-cart"></i></button></li>
                      <li><button><i class="ti-heart"></i></button></li>
                  ...
                  <div class="card-body">
                    <p>Decor</p>
                    <h4 class="card-product__title"><a href="neckless3.php">Neck design Necklace</a></h4>
              ...
              <div class="col-md-6 col-lg-4">
                <div class="card text-center card-product">
                  <div class="card-product__img">
                    <img class="card-img" src="img/neckless4.jpg" alt="" style="width: 250px;height: 180px;">
                    <ul class="card-product__imgOverlay">
                      <li><button><i class="ti-search"></i></button></li>
                      <li><button><i class="ti-shopping-cart"></i></button></li>
                      <li><button><i class="ti-heart"></i></button></li>
                  ...
                  <div class="card-body">
                    <p>Beauty</p>
                    <h4 class="card-product__title"><a href="neckless4.php">Gold Necklace</a></h4>
              ...
              <div class="col-md-6 col-lg-4">
                <div class="card text-center card-product">
                  <div class="card-product__img">
                    <img class="card-img" src="img/neckless5.jpg" alt="" style="width: 250px;height: 180px;">
                    <ul class="card-product__imgOverlay">
                      <li><button><i class="ti-search"></i></button></li>
                      <li><button><i class="ti-shopping-cart"></i></button></li>
                      <li><button><i class="ti-heart"></i></button></li>
                  ...
                  <div class="card-body">
                    <p>Accessories</p>
                    <h4 class="card-product__title"><a href="neckless5.php">Stylish gold plated designers Necklace</a></h4>
              ...
              <div class="col-md-6 col-lg-4">
                <div class="card text-center card-product">
                  <div class="card-product__img">
                    <img class="card-img" src="img/neckless6.jpg" alt="" style="width: 250px;height: 180px;">
                    <ul class="card-product__imgOverlay">
                      <li><button><i class="ti-search"></i></button></li>
                      <li><button><i class="ti-shopping-cart"></i></button></li>
                      <li><button><i class="ti-heart"></i></button></li>
                  ...
                  <div class="card-body">
                    <p>export</p>
                    <h4 class="card-product__title"><a href="neckless6.php">Rose handmade Necklace</a></h4>
