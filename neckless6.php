			...
			<div class="row s_product_inner">
				<div class="col-lg-6">
					<div class="owl-carousel owl-theme s_Product_carousel">
						<div class="single-prd-item">
							<img class="img-fluid" src="img/neckless6.jpg" alt="">
						</div>
						<!-- <div class="single-prd-item">
				...
				<div class="col-lg-5 offset-lg-1">
					<div class="s_product_text">
						<h3>Rose handmade Necklace</h3>
						<h2>Rs.25000.00</h2>
						<ul class="list">
							<li><a class="active" href="#"><span>Category</span> : Household</a></li>
							<li><a href="#"><span>Availibility</span> : In Stock</a></li>
						</ul>
						<p>Product Details Cream Rose designer statement handmade dark blue agate gemstone necklace. Modern , beautiful silver beaded flower necklace. Handmade with Lots of Love. Necklace is 18.5 inches, Beautiful gift boxed.</p>
