			...
			<div class="row s_product_inner">
				<div class="col-lg-6">
					<div class="owl-carousel owl-theme s_Product_carousel">
						<div class="single-prd-item">
							<img class="img-fluid" src="img/bangles6.jpg" alt="">
						</div>
						<!-- <div class="single-prd-item">
				...
				<div class="col-lg-5 offset-lg-1">
					<div class="s_product_text">
						<h3>Alloy style bangles</h3>
						<h2>Rs.2500.00</h2>
						<ul class="list">
							<li><a class="active" href="#"><span>Category</span> : Household</a></li>
							<li><a href="#"><span>Availibility</span> : In Stock</a></li>
						</ul>
						<p>Jaunty Overseas Private Limited - offering Golden Color Alloy Dotted Bangles Set at Rs 75/set in ... Get best price and read about company and get contact details and address. ... Explore similar products View all products in Fashion Bangles ...</p>
